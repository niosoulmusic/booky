...
import com.riccio.bookmarks.rest.BookmarksController;
...
public class UiControllerTest {
    List<Bookmark> bookmarks = Arrays.asList(
            new Bookmark("nice publisher",
                    "http://riccio.com").withUuid(UUID.randomUUID()),
            new Bookmark("riccio  homepage", "http://riccio.com")
...
//        });
        ...
        assertThat(s, containsString("riccio.com"));
